...
<div className='flex gap-3 flex-wrap'>
  ...
  <TechStackToolTip techStack='Twilio' className='size-10' />
...
Here is my application demo video for bachelor's degree thesis (delivered in _bahasa_). You can try it by your self at [beta.chalo.fun](https://beta.chalo.fun)
